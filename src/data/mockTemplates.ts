...
export const mockTemplateSets: TemplateSet[] = [
  {
    ...
    templates: [
      { id: "t-1a", name: "Landscape", preview: "", type: "landscape", tokenCost: 1, setId: "ts-1" },
      { id: "t-1b", name: "Square", preview: "", type: "square", tokenCost: 1, setId: "ts-1" },
      { id: "t-1c", name: "Story", preview: "", type: "story", tokenCost: 1, setId: "ts-1" },
    ],
  },
  {
    id: "ts-2",
    ...
    templates: [
      { id: "t-2a", name: "Square", preview: "", type: "square", tokenCost: 1, setId: "ts-2" },
      { id: "t-2b", name: "Story", preview: "", type: "story", tokenCost: 1, setId: "ts-2" },
    ],
  },
];
